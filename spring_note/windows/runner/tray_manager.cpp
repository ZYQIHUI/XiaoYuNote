...
constexpr UINT kOpenKbMenuId = 0x1003;
...
NOTIFYICONDATA BuildIconData(HWND window) {
  ...
  wcscpy_s(data.szTip, L"XiaoYuNote");
  return data;
}
...
void TrayManager::ShowContextMenu() {
  ...
  AppendMenu(menu, MF_STRING, kOpenMenuId, L"\u6253\u5f00 XiaoYuNote");
  AppendMenu(menu, MF_STRING, kOpenKbMenuId, L"\u6253\u5f00\u77e5\u8bc6\u5e93");
