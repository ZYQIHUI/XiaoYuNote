...
void main() {
  test('cleanup service maps Rust scan results', () async {
    ...
    expect(api.scannedDataDirectory, r'D:\Temp\XiaoYuNote');
  ...
  test('cleanup service sends only relative candidates to Rust', () async {
    ...
    expect(api.deletedDataDirectory, r'D:\Temp\XiaoYuNote');
...
LocalDataState _state() {
  return LocalDataState(
    dataDirectory: r'D:\Temp\XiaoYuNote',
    configPath: r'D:\Temp\XiaoYuNote\config.json',
    dailyNotesDirectory: r'D:\Temp\XiaoYuNote\notes\daily',
    weeklyNotesDirectory: r'D:\Temp\XiaoYuNote\notes\weekly',
    monthlyNotesDirectory: r'D:\Temp\XiaoYuNote\notes\monthly',
