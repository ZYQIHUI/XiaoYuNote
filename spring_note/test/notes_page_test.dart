...
''';
  ...
  testWidgets(
    ...
    (WidgetTester tester) async {
      ...
      pickerCompleter.complete(const [
        NoteImageAttachment(
          path: 'D:\\Temp\\XiaoYuNote\\assets\\screenshot.png',
          name: 'screenshot.png',
        ),
      ]);
      await tester.pump();
  ...
  testWidgets(
    ...
    (WidgetTester tester) async {
      ...
      const imagePath = 'D:\\Temp\\XiaoYuNote\\assets\\screenshot.png';
      final migratedState = _localDataState.copyWith(
        dataDirectory: 'E:\\XiaoYuNoteData',
        configPath: 'E:\\XiaoYuNoteData\\config.json',
        dailyNotesDirectory: 'E:\\XiaoYuNoteData\\notes\\daily',
        weeklyNotesDirectory: 'E:\\XiaoYuNoteData\\notes\\weekly',
        monthlyNotesDirectory: 'E:\\XiaoYuNoteData\\notes\\monthly',
      );
      final pastedImageService = _MemoryPastedImageService(
        const SavedPastedImage(
          path: 'E:\\XiaoYuNoteData\\notes\\images\\screenshot.png',
          name: 'screenshot.png',
        ),
      );
      final noteService = _MemoryNoteService({
