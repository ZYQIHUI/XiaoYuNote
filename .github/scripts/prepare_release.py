#!/usr/bin/env python3
"""Prepare XiaoYuNote release metadata from pubspec and CHANGELOG."""
...
def main() -> None:
    ...
    release_name = f"XiaoYuNote v{version}：{title_suffix}"
    macos_asset = f"XiaoYuNote-{version}-macos-arm64.dmg"
    windows_asset = f"XiaoYuNote-{version}-windows-x64-setup.exe"
