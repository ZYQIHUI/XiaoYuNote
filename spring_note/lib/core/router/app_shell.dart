...
enum AppSection { home, notes, memory, kb, settings }
                      ...
                      child: IndexedStack(
                        ...
                        children: [
                          HomePage(
                            ...
                            onOpenKb: () => _selectSection(AppSection.kb),
                          ),
                          NotesPage(
                            localDataState: _localDataState,
...
IconData _legacyMaterialIcon(_SidebarIconType icon) {
  return switch (icon) {
    ...
    _SidebarIconType.database => Icons.storage_outlined,
    _SidebarIconType.settings => Icons.settings_outlined,
  };
}

enum _SidebarIconType { layoutDashboard, stickyNote, bookOpen, database, settings }
